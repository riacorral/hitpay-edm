...
const TEMPLATES = [
  { id: 'product-launch', label: 'Product Launch', emoji: '🚀', desc: 'Announce a new product with hero image and features' },
  { id: 'feature-update', label: 'Feature Update', emoji: '✨', desc: 'Highlight what\'s new this month' },
  { id: 'newsletter', label: 'Newsletter', emoji: '📰', desc: 'Multi-section digest with metrics' },
  { id: 'promotional', label: 'Promotional', emoji: '🎁', desc: 'Promo code, discount, and expiry date' },
  { id: 'event-invitation', label: 'Event Invitation', emoji: '📅', desc: 'Event details and register CTA' },
  { id: 'partner-spotlight', label: 'Partner Spotlight', emoji: '🤝', desc: 'Feature a partner with logo and story' },
];
...
const TEMPLATE_FIELDS: Record<string, FieldDef[]> = {
  'product-launch': [
    ...
    { key: 'heroImage', label: 'Hero Image URL', placeholder: 'https://...', type: 'url', hint: 'Optional' },
  ...
  'event-invitation': [
    ...
    { key: 'ctaUrl', label: 'Fallback Button URL', placeholder: 'https://hitpayapp.com', required: true, type: 'url', hint: 'Required by the template' },
  ...
  'partner-spotlight': [
    ...
    { key: 'ctaUrl', label: 'Button URL', placeholder: 'https://hitpayapp.com', required: true, type: 'url' },
    { key: 'partnerLogo', label: 'Partner Logo URL', placeholder: 'https://...', type: 'url' },
    { key: 'ctaText', label: 'Button Text', placeholder: 'Read More (default)' },
  ],
};

const BODY_PLACEHOLDERS: Record<string, string> = {
  'product-launch': `Write the main announcement here.
...
Keep it concise — 2–4 short paragraphs works best.`,
  'feature-update': `Describe what's new this month.
...
Add as many sections as you need.`,
  'promotional': `Describe the offer here — what's included and why it's valuable.

Keep it punchy — 1–2 short paragraphs is enough.

Remind them the offer is time-limited.`,
  'event-invitation': `Tell them what the event is about and why they should attend.

What will they learn? Who else is going?

Keep it exciting and action-oriented.`,
  'partner-spotlight': `Tell the partner story here. Who are they, what do they do, why does this partnership matter?
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-5 space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g. Introducing HitPay QR"
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g. Something exciting is here."
                    className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-100"
                  />
                </div>
              </div>
